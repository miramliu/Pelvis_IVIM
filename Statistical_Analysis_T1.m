...
% is different for T1 just due to the mask being double sliced
...
function Statistical_Analysis_T1(Patient_ID, Parameter_Name, ExcelFileName, contours, Image_Map)
    ...
    for n = 1:size(contours,2)
        ...
        mask = mask(:,:,1:2:59); % this accounts for double slicing (slices appearing twice) and assumes 30 slices. adjust as needbe.
